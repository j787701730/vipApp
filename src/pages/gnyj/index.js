...
export default class Index extends Component {
  ...
  _getData = () => {
    ...
    ajax(`https://apis.juhe.cn/gnyj/query?`, "", false, data => {
      Taro.hideLoading();
      ...
      >
        ...
        >
          {result &&
            result.map(el => {
              return (
                <View key={`${el["city"]}`} style={{ padding: "0 10px 10px" }}>
                  <View
                    style={{
                      lineHeight: "34px",
                      textAlign: "left",
        ...
        >
          ...
          <View
            style={{ width: "50%", lineHeight: "40px", textAlign: "center" }}
          >
